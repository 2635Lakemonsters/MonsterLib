...
public class CANTalonEncoderPosition extends OutputOnlyDataProvider<Double> 
{
	...
	protected Double calculateData(Void unused)
	{
		...
		return (double) CanTalonJNI.GetEncPosition(handleParameter.get());
		
	}
	public CANTalonEncoderPosition(UserSetup<CANTalonEncoderPosition> s)
	{
		s.setup(this);
	}
}
